    ...
    <div class="container mx-auto px-4">
            ...
            <div class="grid lg:grid-cols-3 gap-8" 
                ...
                <div class="lg:col-span-2 space-y-4">
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                            <div class="flex gap-6">
                                ...
                                <div class="flex-shrink-0">
                                    <div class="w-24 h-24 md:w-32 md:h-32 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 overflow-hidden">
                                        <img 
                                            :src="item.image" 
                                            :alt="item.name"
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="flex items-center gap-2 border border-gray-300 rounded-lg">
                                                <button 
                                                    ...
                                                    class="w-8 h-8 flex items-center justify-center text-gray-700 hover:bg-gray-100 rounded-l-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                ...
                                                <input 
                                                    ...
                                                    min="1"
                                                    max="99"
                                                    class="w-12 text-center text-sm font-bold border-0 focus:ring-0 outline-none"
                                                >
                                                
                                                <button 
                                                    @click="updateQuantity(item.id, item.quantity + 1)"
                                                    :disabled="item.quantity >= 99"
                                                    class="w-8 h-8 flex items-center justify-center text-gray-700 hover:bg-gray-100 rounded-r-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                                >
                                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="pt-4">
                        <a 
                            href="/"
                            class="inline-flex items-center text-gray-700 hover:text-gray-900 font-semibold transition-colors group"
                        >
        ...
        @else
            ...
            <div class="max-w-md mx-auto text-center py-16">
                <div class="bg-white rounded-2xl border-2 border-dashed border-gray-300 p-12">
                    {{-- Empty Cart Icon --}}
                    <div class="mb-6">
                    ...
                    <p class="text-gray-600 mb-8">¡Empieza a agregar productos increíbles!</p>

                    <a 
                        href="/"
                        class="inline-flex items-center bg-gray-900 text-white font-bold px-8 py-3 rounded-lg hover:bg-gray-800 transition-all duration-200 shadow-lg hover:shadow-xl"
                    >
